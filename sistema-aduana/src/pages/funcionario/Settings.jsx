// src/pages/funcionario/Settings.jsx
import React, { useState, useEffect } from 'react';

export default function SettingsFuncionario() {
  ...
  useEffect(() => {
    ...
    document.title = 'Ajustes Funcionario';
  }, []);
  ...
  const handleSave = (e) => {
    ...
    // TODO: llamada al API para guardar...
  ...
  return (
    <div role="main" className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md max-w-md mx-auto">
      <h2 role="heading" aria-level="2" className="text-2xl font-semibold mb-6 text-gray-800 dark:text-gray-100">
        Ajustes de Funcionario
      </h2>
      <form onSubmit={handleSave} className="space-y-6">
        {/* Nombre (solo lectura) */}
        <div>
          <label htmlFor="func-name" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            Nombre
          </label>
          <input
            id="func-name"
        ...
        {/* RUT (solo lectura) */}
        <div>
          <label htmlFor="func-rut" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            RUT
          </label>
          <input
            id="func-rut"
        ...
        <div>
          <label htmlFor="func-confirmPwd" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
            Confirmar contraseña
          </label>
          <input
            id="func-confirmPwd"
